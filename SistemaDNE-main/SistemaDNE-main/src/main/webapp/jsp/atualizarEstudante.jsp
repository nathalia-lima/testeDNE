...
<html>
	<head>
		<meta charset="UTF-8">
		<title> Sistema DNE </title>
	</head>
<center>
	<body>
		<h2>Suspender Carteirinha </h2>
		<jsp:useBean id="estudantes" scope="session" class="br.edu.dne.model.Estudantes" />
		<form action="ServletEstudante?cmd=atualizar" method="post">
	<form>
		<table border="1">
			<tr>
				<td>Email:</td>
			...
			<tr>
				<td>Genero:</td>
				<td><input type="text" size="26" name="cmbGenero" value="<%=estudantes.getGenero()%>" readonly="readonly" /></td>
			</tr>
			<tr>
				<td>Celular:</td>
			...
			<tr>
				<td>Supender carteirinha:</td>
				<td><select size="1" name="cmbSuspender">
							<option>Sim</option>
							<option>Nao</option>
						</select></td>
			</tr>
